...
> **ⓘ &nbsp;Note**<br><br> If you're using Fedora or CentOS, you don't need to install a separate package, since both server and client packages are combined within `nfs-utils`.
