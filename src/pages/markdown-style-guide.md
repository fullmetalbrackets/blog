...
#secondary-light { color: #000; background-color:#5fc1e8; font-weight: 900; }
...
<div class="light-colors">
  ...
  <span id="secondary-light">Tags Hover<br><br> 5FC1E8 #</span>
  <span id="primary-light">Headings/Tags<br><br> 2596BE #</span>
  <span id="accent-light">Accent<br><br> 94A3B8 #</span>
  <span id="emphasis-light">Emphasis<br><br> DC2800 #</span>
  <span id="logo-light">Logo<br><br> 00AFAF #</span>
...
#secondary { color: #000; background-color:#94A3B8; font-weight: 900; }
...
<div class="dark-colors">
  ...
  <span id="secondary">Tags Hover<br><br> 94A3B8 #</span>
  <span id="primary">Headings/Tags<br><br> FAFAFA #</span>
  <span id="accent">Accent<br><br> 334155 #</span>
  <span id="emphasis">Emphasis<br><br> FF4500 #</span>
  <span id="logo">Logo<br><br> FF00B3 #</span>
