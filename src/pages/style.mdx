...
title: Style Guide
description: Style guide for fullmetalbrackets.com
---

export const prerender = true;

<a class='u-url' href='https://fullmetalbrackets.com/style' hidden>
  Permalink
</a>
...
<li class='style'>
  <span class='main-font b'>
    [Atkinson Hyperlegible](https://www.brailleinstitute.org/freefont/)
  </span>
  <span>&nbsp;for body text and blog post headings.</span>
</li>
<li class='style'>
  <span class='code-font b'>
    [Atkinson Hyperlegible
    Mono](https://github.com/googlefonts/atkinson-hyperlegible-next-mono)
  </span>
  <span>&nbsp; for inline code and Prism code blocks.</span>
</li>
<li class='style'>
  <span class='sub-font b'>
    [Nunito](https://fonts.google.com/specimen/Nunito)
  </span>
  <span>&nbsp; for buttons and main page headings.</span>
</li>
...
(**Note:** The `<h2>` element has extra top margin and a bottom border for
design reasons.)

# H1 - Page/Post Title

Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cum exercitationem
consequuntur quia placeat illum ex enim rerum quis aliquam. Accusamus.
...
Here is a simple image using Markdown. (Images embedded using markdown syntax
and stored in `/src/img` will be processed and optimized by Astro Image.)
...
To use an image in a `figure` element with a `figcaption`,
[RemarkDirective](https://github.com/remarkjs/remark-directive) and
[RemarkDirectiveSugar](https://github.com/lin-stephanie/remark-directive-sugar)
allows using custom markdown syntax.
...
I use the default `<blockquote>` element as an "information" block almost
exclusively.
...
I also have differently styled data types for other kinds of blockquotes, which
I use less often. This is the `[quote]` data type for actual quotes and
attribution.

```markdown
> [quote]
>
> This is a direct quote from a person or article. --Author, Book, pg. 69, etc.
```

> [quote] This is a direct quote from a person or article.
>
> --Author, Book, pg. 69, etc.

<br />
And this is the `[warning]` data type for things more important or urgent
information.
...
I like lists! I use them all the time in the blog and wiki becausing organizing
information using lists pleases my brain.
...
`<abbr title="Graphics Interchange Format">GIF</abbr>` becomes
...
`X<sup>n</sup> + Y<sup>n</sup> = Z<sup>n</sup>` becomes X<sup>n</sup> +
...
`<kbd><kbd>CTRL</kbd>+<kbd>ALT</kbd>+<kbd>Delete</kbd></kbd>` becomes
