...
Style guide for this website. You may also be interested in the [Colophon](/colophon).
...
The following HTML `<h1>`—`<h6>` elements represent six levels of section headings. `<h1>` is the highest section level while `<h6>` is the lowest. (**Note:** The `<h2>` element has extra top margin and a bottom border for design reasons.)
