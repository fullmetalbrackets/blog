...
I followed the <a href="https://docs.pi-hole.net/guides/dns/unbound/" target="_blank" data-umami-event="sweet-potato-debian-pihole-phdocs">official Pi-Hole docs instructions for using Unbound as a recursive DNS server</a> to the letter, and had everything up and running within 5 minutes. In short:
