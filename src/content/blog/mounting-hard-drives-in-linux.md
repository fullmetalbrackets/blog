...
[![Screenshot of lsblk output](../../img/mount1.png)](../../img/mount1.png)
...
[![Screenshot of output from command lsblk | grep -v 7:](../../img/mount2.png)](../../img/mount2.png)
...
[![Screenshot of fstab file](../../img/mount3.png)](../../img/mount3.png)
...
[![Screenshot of blkid output](../../img/mount4.png)](../../img/mount4.png)
...
[![Screenshot of fstab file](../../img/mount5.png)](../../img/mount5.png)
...
<div>
  <div class="alert">
    ...
    <p>
      The number at the end of each line, under pass, is important; this is essentially the order in which partitions will become accessible to the OS. Make sure your main partition, mounted on the root directory, is always set to <code>1</code> in fstab. All additional hard drives and partitions should be set to <code>2</code>. Linux may misbehave if you set another drive to <code>1</code>, it's best to ignore ANY lines that were in fstab before the first time you opened it -- only add new ones!
    </p>
  </div>
</div>
