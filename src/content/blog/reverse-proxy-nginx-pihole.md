---
title: 'Set up a reverse proxy for OpenMediaVault, Plex and Navidrome using Nginx Proxy Manager and Pi-Hole'
...
tags: ['self-hosting', 'openmediavault', 'nginx proxy manager', 'guide']
