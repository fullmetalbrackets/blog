...
<div class="alert">
  <span>
    <img src="/assets/alert.svg" alt="Important" class="alert-icon" alt="Important" loading="lazy" decoding="async"> <b>Important!</b>
  </span>
  <p>
...
<div class="note">
  <span>
    <img src="/assets/note.svg" alt="Note" class="note-icon" alt="Note" loading="lazy" decoding="async" />
    <b>Note</b>
  </span>
  <p>
...
[![Screenshot of DNS Settings.](../../img/dns1.png)](../../img/dns1.png)
...
[![Screenshot of Pi-Hole UI showing Adlists section.](../../img/adlist.png)](../../img/adlist.png)
...
[![Screenshot of over 3 million domains blocked on Pi-Hole dashboard.](../../img/blocked.png)](../../img/blocked.png)
...
[![Screenshot of Conditional Forwarding setting.](../../img/dns2.png)](../../img/dns2.png)
...
[![Screenshot of advanced DNS settings.](../../img/dns3.png)](../../img/dns3.png)
...
[![Screenshot of add new domain/IP combination page.](../../img/dns4.png)](../../img/dns4.png)
...
<div>
  <div class="note">
    ...
    <p>
      The following is all optional, but in some cases they will make Pi-Hole more useful (like pairing it with Unbound) or easier to manage. (Updating outside normal hours.)
    </p>
  </div>
</div>
