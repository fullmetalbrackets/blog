...
- <a href="https://tailscale.com" target="_blank" data-umami-event="expose-plex-cloudflare-alternatives-tailscale">Tailscale</a>, a Wireguard-based overlay network for connecting devices across different networks. As I mentioned at the top of this article, I chose to [use Tailscale with a free Oracle VM to expose Plex](/blog/expose-plex-tailscale-vps/) and strongly suggest it to anyone!
